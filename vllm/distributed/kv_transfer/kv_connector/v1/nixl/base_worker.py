    ...
    def register_kv_caches(self, kv_caches: dict[str, torch.Tensor]):
        ...
        for layer_name in layer_names:
            ...
            if isinstance(layer_spec, MambaSpec):
                ...
                # The tail is replicated raw K + gate state. Its HMA page can
                # be padded or live at an offset inside a shared allocation;
                # neither changes the number of live bytes per block.
