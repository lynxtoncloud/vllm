...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_GFX1100_GLM53: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Experimental eager BF16 GLM-5.3-Flash fallbacks on Radeon gfx1100.
    "VLLM_ROCM_GFX1100_GLM53": lambda: bool(
        int(os.getenv("VLLM_ROCM_GFX1100_GLM53", "0"))
    ),
